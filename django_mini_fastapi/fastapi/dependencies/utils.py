...
from ..mock import BackgroundTasks
...
from ...base import Request, Response, TempResponse
from ..mock import WebSocket, HTTPConnection
...
def solve_dependencies(
    *,
    ...
    response: Optional[TempResponse] = None,
    ...
    path_values, path_errors = request_params_to_args(
        dependant.path_params, request.path_kwargs
    )
    query_values, query_errors = request_params_to_args(
        dependant.query_params, request.GET
    )
    header_values, header_errors = request_params_to_args(
        dependant.header_params, request.META
    )
    ...
    if dependant.body_params:
        (body_values, body_errors,) = request_body_to_args(  # body_params checked above
    ...
    if required_params:
        ...
        for field in required_params:
            ...
            if (
                ...
                contents = [sub_value.read() for sub_value in value]
